...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        String basePath = "/com/detyrat_ai/detyra1/";
    ...
    private Button createTaskButton(String text, String iconName, javafx.event.EventHandler<javafx.event.ActionEvent> action) {
        ImageView icon = new ImageView(new Image(getClass().getResourceAsStream("/com/detyrat_ai/icons/" + iconName)));
